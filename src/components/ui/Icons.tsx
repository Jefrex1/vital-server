...
const ic = (path: React.ReactNode, vb = "0 0 24 24") =>
  ({ size = 14, color = "currentColor", style }: IconProps) => (
    <svg width={size} height={size} viewBox={vb} fill="none" stroke={color} strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" style={{ display: "inline-block", flexShrink: 0, ...style }}>
      {path}
    </svg>
  );
...
export const IconFile = ic(<><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></>);
...
export const IconCrown = ic(<><path d="M2 20h20"/><path d="M5 20V10l7-7 7 7v10"/></>);
export const IconShare = ic(<><circle cx="18" cy="5" r="3"/><circle cx="6" cy="12" r="3"/><circle cx="18" cy="19" r="3"/><line x1="8.59" y1="13.51" x2="15.42" y2="17.49"/><line x1="15.41" y1="6.51" x2="8.59" y2="10.49"/></>);
export const IconShield2 = ic(<><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><polyline points="9 12 11 14 15 10"/></>);
